...
export const softwareProjects = [
    {
        ...
        purpose:
            "Designed for exploring complex conformational landscapes when reaction coordinates are not known in advance. Runs parallel short simulations, tracks particle lineage, and spawns new trajectories from sparse or promising regions.",
        capabilities: [
...
continuous_path.write_xtc("rare_transition.xtc")`,
    ...
    },
    {
        ...
        purpose:
            "Accelerates rare-event molecular-dynamics simulations by spawning short parallel MD segments and steering exploration along progress coordinates using real-time direction vectors.",
        capabilities: [
...
transition_pathways.write_trajectory("rare_event_pathway.xtc")`,
    ...
    },
    {
        ...
        name: "IceCoder",
        tagline:
            "Unsupervised representation-learning framework for ice polymorph and liquid environment classification.",
        purpose:
            "Classifies and identifies local molecular environments in water and ice phases directly from trajectories. Combines SOAP local density descriptors with variational autoencoders.",
        capabilities: [
...
print(f"Latent space shape: {latent_space.shape}")`,
    ...
    },
    {
        ...
        purpose:
            "Utility library for computing local structural order parameters, hydration shell coordination numbers, tetrahedrality indices, and radial density profiles from atomistic MD trajectories.",
        capabilities: [
